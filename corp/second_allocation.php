...
<head>
    ...
    <title>GCAP SLOTS - Second Allocation</title>
...
<body>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="second_allocation_func.php" method="POST">
                                ...
                                <table class="table table-striped table-borderless" id="datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            $query = "SELECT * FROM second_prize_allocation ORDER BY id DESC";
    ...
    <?php include('second_allocation_modal.php'); ?>
